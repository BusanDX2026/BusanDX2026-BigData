...
# T03 검증
save(pd.DataFrame([
    # 2026-09-06: 랜덤 CV 수치가 D8 수정 이전(PR-AUC 0.2445) 기준으로 남아 있었다.
    #   최종 16피처 모델로 재측정 — 랜덤 StratifiedKFold5 0.5189 vs 자치구 GroupKFold5 0.3059 = +70%.
    ["공간 교차검증", "자치구 GroupKFold 5-fold", "PR-AUC 0.3059", "랜덤 K-fold(0.5189)는 +70% 과대평가 — 공간 자기상관 제거"],
